...
namespace Azure.Maps.TimeZone
{
    public partial class TimezoneId
    {
        internal static TimezoneId DeserializeTimezoneId(JsonElement element)
        {
            ...
            Optional<ReferenceTime> referenceTime = default;
            ...
            return new TimezoneId(id.Value, Optional.ToList(aliases), Optional.ToList(countries), names.Value, referenceTime.Value, representativePoint.Value, Optional.ToList(timeTransitions));
        }
    }
}
